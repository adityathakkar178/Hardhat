...
contract MyERC1155 is ERC1155{
    ...
    function sell(uint256 _tokenId, uint256 _amount, uint256 _price) public {
        ...
        saleToken[_tokenId] = Seller(msg.sender, _tokenId, _amount, _price);
    }

    function buy(uint256 _tokenId) public payable{
        require(saleToken[_tokenId].seller != address(0), "Token not for sell");
        ...
        _safeTransferFrom(saleToken[_tokenId].seller, msg.sender, _tokenId, saleToken[_tokenId].amount, "");
        if (royalty > 0) {
